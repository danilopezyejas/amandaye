...
"""
Django settings for amandaye_backend project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-2^r=x$&rb=37awz4gmobkv@gqa#gtg316s_d3c4^z!2jo1g)xx')
...
MIDDLEWARE = [
    'amandaye_backend.middleware.Redirect404Middleware',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR.parent, 'amandaye_frontend'),
